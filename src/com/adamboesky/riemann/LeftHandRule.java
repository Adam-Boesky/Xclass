...
public class LeftHandRule extends AbstractRiemann {
    ...
    public double slice(Polynomial poly, double sleft, double sright) {
        ...
        double rectHeight = poly.evaluateWith(sleft);
    ...
    public void slicePlot​(PlotFrame pframe, Polynomial poly, double sleft, double sright) {
        double rectCenterX = sright - (calculateDeltaX(sleft, sright, 1)/2);
        double rectCenterY = poly.evaluateWith(sleft)/2;
        double rectWidth = Math.abs(calculateDeltaX(sleft, sright, 1));
        double rectHeight = Math.abs(poly.evaluateWith(sleft));
